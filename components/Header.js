  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm ">
        ...
        />
        <SearchIcon className="hidden md:inline-flex h-8 bg-red-400 text-white rounded-full p-2 hover:cursor-pointer md:mx-2" />
      </div>
      {/** right */}
      <div className="flex space-x-4 items-center justify-end text-gray-500">
        ...
        <div className="flex border-2 rounded-full items-center space-x-2 p-2 hover:cursor-pointer">
